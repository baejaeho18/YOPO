...
df = pd.read_csv(BASE_DIR + "/dataset/from_adflush/features_raw_except_target.csv")

cols_to_encode_cat_bin = feature_names_adflush.FEATURES_CATEGORICAL + feature_names_adflush.FEATURES_BINARY
...
# Save
df_final.to_csv(BASE_DIR + "/dataset/from_adflush/features_nn.csv", index=False)
