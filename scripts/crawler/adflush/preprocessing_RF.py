...
# save original one
df.to_csv("/yopo-artifact/data/dataset/from_adflush/features_rf_all.csv", index=False)
...
df.to_csv("/yopo-artifact/data/dataset/from_adflush/features_rf.csv", index=False)
df_orig.to_csv("/yopo-artifact/data/dataset/from_adflush/features_raw_except_target.csv", index=False)
target_df.to_csv("/yopo-artifact/data/dataset/from_adflush/target_features_rf_oversampled.csv", index=False)
