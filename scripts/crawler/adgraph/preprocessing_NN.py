...
df = pd.read_csv(BASE_DIR + "/dataset/from_adgraph/features_raw_except_target.csv")

cols_to_encode_cat_bin = feature_names_adgraph.FEATURES_CATEGORICAL + feature_names_adgraph.FEATURES_BINARY
...
# Save
df_final.to_csv(BASE_DIR + "/dataset/from_adgraph/features_nn.csv", index=False)
