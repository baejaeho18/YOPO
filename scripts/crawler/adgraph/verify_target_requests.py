...
if args.oversampled:
    target_csv = "/yopo-artifact/data/dataset/from_adgraph/target_features_rf_oversampled.csv"
else:
...
def compute_diff():
    diff = dict()
    diff = {"FEATURE_SEMICOLON_PRESENT": 1, "FEATURE_URL_LENGTH": 5}
...
domain = ""
url = ""
perturbed_url_file = open('/yopo-artifact/scripts/crawler/adgraph/perturbed_url_for_target_adgraph.csv', 'w', newline='')
...
if args.oversampled:
    ...
    df_oversampled = pd.read_csv('/yopo-artifact/data/dataset/from_adgraph/target_features_rf_oversampled.csv')
    filtered_df = df_oversampled.iloc[filtered_indices]
    filtered_df.to_csv('/yopo-artifact/data/dataset/from_adgraph/target_features_rf_full.csv', index=False)
    ...
    filtered_df_excluded.to_csv('/yopo-artifact/data/dataset/from_adgraph/target_features_rf.csv', index=False)
