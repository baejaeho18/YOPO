...
def make_mod_mapping():
    ...
    dir_path = "/yopo-artifact/data/rendering_stream/modified_html_webgraph"
    csv_file_path = "/yopo-artifact/data/rendering_stream/map_local_list_mod_final.csv"
    new_csv_file_path = "/yopo-artifact/data/rendering_stream/mod_mappings_webgraph/map_mod_0.csv"
    
    filenames, urlnames = get_filenames_in_directory(dir_path)
    create_dict(csv_file_path)
    
    lines = []
    prefix = "/yopo-artifact/data/rendering_stream/modified_html_webgraph/"
...
def split_csv():
    ...
    while(True):
        ...
        with open('/yopo-artifact/data/rendering_stream/mod_mappings_webgraph/map_mod_{}.csv'.format(turn), 'w', newline='') as remaining_file:
        ...
        with open('/yopo-artifact/data/rendering_stream/mod_mappings_webgraph/map_mod_{}.csv'.format(turn + 1), 'w', newline='') as unique_file:
