...
csv_name = "from_adflush/features_rf.csv"
...
# Save
os.makedirs(os.path.dirname('/yopo-artifact/data/dataset/from_adflush/saved_model_adflush/rf_model_30perc.pt'), exist_ok=True)
if best_clf is not None:
    with open('/yopo-artifact/data/dataset/from_adflush/saved_model_adflush/rf_model_30perc.pt', 'wb') as f:
