...
csv_name = "from_pagegraph/features_rf.csv"
...
# Save
os.makedirs(os.path.dirname('/yopo-artifact/data/dataset/from_pagegraph/saved_model_pagegraph/rf_model_30perc.pt'), exist_ok=True)
if best_clf is not None:
    with open('/yopo-artifact/data/dataset/from_pagegraph/saved_model_pagegraph/rf_model_30perc.pt', 'wb') as f:
